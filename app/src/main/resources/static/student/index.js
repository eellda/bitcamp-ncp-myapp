...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/bitcamp-bucket11-member-photo/${student.photo}`;
        document.querySelector("#f-photo").src = `http://wcbifehsxnfx16694934.cdn.ntruss.com/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
